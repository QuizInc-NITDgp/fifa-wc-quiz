...
const SOCIALS = [
  {
    ...
    href: "https://chat.whatsapp.com/YOUR_GROUP_LINK", // ← replace
    color: "#25D366",
  ...
  },
  {
    ...
    href: "https://www.instagram.com/quizincnitdgp/", // ← replace
    color: "#E1306C",
  ...
  },
  {
    ...
    href: "https://www.facebook.com/quizinc.nitd/", // ← replace
    color: "#1877F2",
  ...
  },
  {
    ...
    href: "https://in.linkedin.com/company/quizinc", // ← replace
    color: "#0A66C2",
        ...
        <div className="panel-in w-full max-w-lg rounded-2xl overflow-hidden border border-white/[0.06] shadow-2xl"
          ...
          <div className="px-7 md:px-10 pt-8 pb-9 flex flex-col gap-7">
            ...
            <div className="grid grid-cols-2 gap-2.5 w-full">
              <div className="stat-in"><StatCard label="Answered" value={`${answeredCount} / 15`} /></div>
            ...
            <div className="rounded-xl px-5 py-4 border"
              ...
              <p className="text-white/50 text-[12px] leading-relaxed text-center">
                ...
                <span className="text-green-400 font-semibold">WhatsApp group</span> and{" "}
                <span className="text-pink-400 font-semibold">Instagram story</span>.
                Stay tuned!
              </p>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-white/20 text-[10px] font-mono uppercase tracking-widest">Follow Us</span>
              <div className="flex-1 h-px" style={{ background: "rgba(255,255,255,0.06)" }} />
            </div>
